...
static const char *fonts[] = {"Hack Nerd Font"};
// static const char dmenufont[] = "Fira Code Nerd Font";
static const char dmenufont[] = "Hack Nerd Font";
#include "themes/ayu-dark.h"
...
/* tagging */
static const char *tags[] = {"󰾔", "󱃖", "", "󰎄", "󰚢",
                             "6",    "7",    "8",   "9"};
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_1, 0) TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1)
        TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3) TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5)
