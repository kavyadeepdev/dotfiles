...
-- Navigate tabs
keymap("n", "<C-S-l>", ":tabn<CR>", opts)
keymap("n", "<C-S-h>", ":tabN<CR>", opts)
...
keymap("n", "<leader>r", "<cmd>lua require'telescope.builtin'.oldfiles(require('telescope.themes').get_dropdown())<cr>", opts)
-- keymap("n", "<leader>w", "<cmd>Telescope live_grep<cr>", opts)
keymap("n", "<leader>w", "<cmd>lua require'telescope.builtin'.live_grep(require('telescope.themes').get_dropdown())<cr>", opts)
